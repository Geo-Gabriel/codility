'''
Uma matriz não vazia A que consiste em N números inteiros é fornecida. A matriz contém um número
ímpar de elementos e cada elemento da matriz pode ser emparelhado com outro elemento que tem o
mesmo valor, exceto por um elemento que não é emparelhado.
